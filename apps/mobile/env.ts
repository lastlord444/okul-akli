...
const BUNDLE_IDS = {
  development: 'com.okulakli.development',
  preview: 'com.okulakli.preview',
  production: 'com.okulakli',
} as const;
...
const SCHEMES = {
  development: 'okulakli',
  preview: 'okulakli.preview',
  production: 'okulakli',
} as const;

const NAME = 'Okul Aklı';
