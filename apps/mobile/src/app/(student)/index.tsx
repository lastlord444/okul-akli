...
const studentCards = [
  ...
  { title: 'Ödevler', description: 'Bekleyen ve tamamlanan ödevlerinizi takip edin', badge: 'Yakında' },
  { title: 'Duyurular', description: 'Okul ve sınıf duyurularını okuyun', badge: 'Yakında' },
];
